function initControlVars(input)

    global Gvars globalVal
...
%     Xmin = min(input.vertCoord(:,1));
%     Ymin = min(input.vertCoord(:,2));
%     Xmax = max(input.vertCoord(:,1));
%     Ymax = max(input.vertCoord(:,2));
%     globalVal.Xmin = Xmin;
%     globalVal.Ymin = Ymin;
%     globalVal.Xmax = Xmax;
%     globalVal.Ymax = Ymax;
%     globalVal.P0 = input.P0;
%     globalVal.L0 = input.L0;
%     globalVal.K = input.K;
%     globalVal.RelaxF = input.RelaxF;
%     globalVal.ScaleFx = input.ScaleFx;
%     globalVal.ScaleFy = input.ScaleFx;
